...
## [1.46.0](https://github.com/ymir1v/wildduck/compare/v1.45.5...v1.46.0) (2025-03-27)


### Features

* added [@forwardemail](https://github.com/forwardemail) to third-party projects ([#716](https://github.com/ymir1v/wildduck/issues/716)) ([66f8c12](https://github.com/ymir1v/wildduck/commit/66f8c123c37f425ed1eb98aa0eae36c6504b4fd5))
* added base support for XAPPLEPUSHSERVICE (per [#711](https://github.com/ymir1v/wildduck/issues/711)) ([#712](https://github.com/ymir1v/wildduck/issues/712)) ([4e96db2](https://github.com/ymir1v/wildduck/commit/4e96db26ad09aecdd4a80ddb6a1723e06437fa8a))
...
* **autoacme:** Allow setting up automatic ACME certificate generation ([cd8596a](https://github.com/ymir1v/wildduck/commit/cd8596a84d36f9870858f3fdc4249f2af42347d9))
...
* **SNI:** Autogenerate TLS certificates for SNI ([40db519](https://github.com/ymir1v/wildduck/commit/40db519d9c08ebe588a6ce820f6287d4f52f038f))
...
* Added thread data to EXPUNGE command ([#783](https://github.com/ymir1v/wildduck/issues/783)) ([5ac345e](https://github.com/ymir1v/wildduck/commit/5ac345e060fd719e71ba7a076abcb8d2e1d1d677))
* **addMessage-moveMessage-async-await:** Rewrite addMessage, moveMessage to async/await ZMS-187 ([#779](https://github.com/ymir1v/wildduck/issues/779)) ([d91f112](https://github.com/ymir1v/wildduck/commit/d91f11233118e4b7a7ce43976adedfdbfedc5427))
...
* **api-addresses:** Main isn't required when updating an address ([#695](https://github.com/ymir1v/wildduck/issues/695)) ([c9188b3](https://github.com/ymir1v/wildduck/commit/c9188b3766b547b091d140a33308b5c3ec3aa1d4))
* **api-all:** Fixes to some API endpoint request and/or response types and schemas ZMS-157 ([#691](https://github.com/ymir1v/wildduck/issues/691)) ([836ca26](https://github.com/ymir1v/wildduck/commit/836ca2601714c2e6337cbbaaaf80e8b5275af821))
* **api-all:** Replaced old documentation with new, autogenerated, one ZMS-154 ([#693](https://github.com/ymir1v/wildduck/issues/693)) ([753997f](https://github.com/ymir1v/wildduck/commit/753997fac7936bd14f564f6773926fc027907a4c))
...
* **api-attachment:** Calculate file content hash when uploading attachment ZMS-172 ([#733](https://github.com/ymir1v/wildduck/issues/733)) ([8730ed5](https://github.com/ymir1v/wildduck/commit/8730ed58f6c7630d63e86bcdc9a755d8904d3df0))
...
* **api-auth:** /preauth and /authenticate endpoints also return the default address of an user ZMS-175 ([#738](https://github.com/ymir1v/wildduck/issues/738)) ([6dac6ae](https://github.com/ymir1v/wildduck/commit/6dac6ae256ef6d4c555363591392f752cd4e51d3))
...
* **api-endpoints:** public_get and acme endpoints excluded from api docs generation ZMS-156 ([#688](https://github.com/ymir1v/wildduck/issues/688)) ([cc832b2](https://github.com/ymir1v/wildduck/commit/cc832b2da7b008e3b2f3ce739e415f0e684b6de2))
...
* **api-generation:** remove "version" from apigeneration.json ZMS-160 ([#729](https://github.com/ymir1v/wildduck/issues/729)) ([971a0f1](https://github.com/ymir1v/wildduck/commit/971a0f1ba1e66c4fe2bad947d090189be605d21d))
* **api-getMessagesList:** getMessages list, add attachmentsList to response for easier attachment handling ZMS-195 ([#773](https://github.com/ymir1v/wildduck/issues/773)) ([959c707](https://github.com/ymir1v/wildduck/commit/959c70734b2b2c09d232aa21fedf64e8c4aadc20))
* **api-graylog-req:** Do not use util.inspect if value already string ZMS-174 ([#736](https://github.com/ymir1v/wildduck/issues/736)) ([1a12b03](https://github.com/ymir1v/wildduck/commit/1a12b03a838a6cc2ebba81d13a6a33a8a5591783))
...
* **api-req_end:** req_end issue fix ZMS-147 ([#681](https://github.com/ymir1v/wildduck/issues/681)) ([ca57ea4](https://github.com/ymir1v/wildduck/commit/ca57ea4897cf0b9bdcac08593005dd54c195c982))
...
* **api-storage:** Added all storage endpoints to API docs generation ZMS-149 ([#675](https://github.com/ymir1v/wildduck/issues/675)) ([8e9af88](https://github.com/ymir1v/wildduck/commit/8e9af88a62960207d68f28fb71cd540be7a66fd5))
* **api-submit:** Added submission api endpoint to api docs generation ([#676](https://github.com/ymir1v/wildduck/issues/676)) ([82133df](https://github.com/ymir1v/wildduck/commit/82133df0c9b01e9bf4fcfcfea6ed660f37aeffe3))
* **api-submit:** Fix submit.js mailboxId and reference request fields ZMS-158 ([#690](https://github.com/ymir1v/wildduck/issues/690)) ([37b6793](https://github.com/ymir1v/wildduck/commit/37b6793976c9d73dc7796bb0f1072472569f4f5b))
* **api-users-updates:** added users/updates api endpoint to api docs generation ZMS-155 ([#687](https://github.com/ymir1v/wildduck/issues/687)) ([490b4e5](https://github.com/ymir1v/wildduck/commit/490b4e5118716107b2b9dcc4c6c74ac00969df1e))
* **api-webhooks:** added all webhook api endpoints to api docs generation ZMS-153 ([#686](https://github.com/ymir1v/wildduck/issues/686)) ([e9abf85](https://github.com/ymir1v/wildduck/commit/e9abf8581f9dcfb2df7b1e317ab0e0e15aa7c4a2))
* **api&imap-mailboxes:** Added mailbox subpath and whole path max length limits to API and IMAP ZMS-169 ([#732](https://github.com/ymir1v/wildduck/issues/732)) ([ee870b9](https://github.com/ymir1v/wildduck/commit/ee870b9fed8a344242349fe36581f4894f190c06))
...
* **autsni:** Fixed garbage collection for unfinished certificates ([5bf6c86](https://github.com/ymir1v/wildduck/commit/5bf6c865428d743f7ce328647146c95e07f3ace2))
* **bimi:** Added 'type' for BIMI information schema ([61f03dc](https://github.com/ymir1v/wildduck/commit/61f03dce8f09e23218b4cd90e88568a5cda3c8ff))
...
* **deps:** Bumped deps to clear out some security warnings ([aacf132](https://github.com/ymir1v/wildduck/commit/aacf1326feb0a3323ad0e874c7d4935232eb1084))
...
* **deps:** Replaced uuid dependency with crypto.randomUUID ([d462b5a](https://github.com/ymir1v/wildduck/commit/d462b5a55fd470c360d5942bbdb14c13ba6765f0))
* **deps:** Upgraded mailauth for BIMI CMC support ([20f8e9a](https://github.com/ymir1v/wildduck/commit/20f8e9a39f14feda0facfa2ba5c4edb0a550811a))
* docker-latest workflow updates. Release workflow refactor, add latest tag on release ZMS-205 ([#797](https://github.com/ymir1v/wildduck/issues/797)) ([e6f6920](https://github.com/ymir1v/wildduck/commit/e6f69204493b94d43b65e8f79caafb75ae63b2e8))
* **docker-workflows:** update workflows to only push to GHCR ([#793](https://github.com/ymir1v/wildduck/issues/793)) ([a6de121](https://github.com/ymir1v/wildduck/commit/a6de121d44ef277a6ddc28ae028a9dd10312cf46))
* **dockerfile:** Use JSON array for CMD ([6d7d47e](https://github.com/ymir1v/wildduck/commit/6d7d47e9eb61cb7fbdab70b6623a3a7ca0c77fa0))
...
* **docs-client-gen:** add more readable operationId and response types, fix deps ZMS-188 ([#759](https://github.com/ymir1v/wildduck/issues/759)) ([978ce06](https://github.com/ymir1v/wildduck/commit/978ce0685f3aa2e10f3c3407bb1b9e732e9cf5f2))
...
* **encrypted-mailboxes:** Add functionality of singular encrypted mailboxes ZMS-181 ([#758](https://github.com/ymir1v/wildduck/issues/758)) ([17bca3e](https://github.com/ymir1v/wildduck/commit/17bca3e9ed21942e37765083d0ac8d5e46379131))
* fixed callback invocations to check if session already closed ([#705](https://github.com/ymir1v/wildduck/issues/705)) ([d06071b](https://github.com/ymir1v/wildduck/commit/d06071b8c592944b56a942402e492c9f4eddca0b))
* fixed edge case where `session` not set and uncaught exception occurs ([#780](https://github.com/ymir1v/wildduck/issues/780)) ([8244559](https://github.com/ymir1v/wildduck/commit/82445592301047d0b43992106091d10456ae5611))
* fixed edge cases when `session` could be `null` ([#699](https://github.com/ymir1v/wildduck/issues/699)) ([a68725d](https://github.com/ymir1v/wildduck/commit/a68725d312b2c1f8684a182531f5dfdfd5ee8e3e))
...
* fixed XAPPLEPUSHSERVICE command (needs to return topic) ([#719](https://github.com/ymir1v/wildduck/issues/719)) ([ba0258f](https://github.com/ymir1v/wildduck/commit/ba0258fc5bc7697ada157f77538eadf667690cd2))
* **general-docs-docker:** fix docker general documentation ZMS-197 ([#774](https://github.com/ymir1v/wildduck/issues/774)) ([284ba63](https://github.com/ymir1v/wildduck/commit/284ba638bd633699c8792ba789722dfeb1bdef20))
...
* **handler-filter:** Filter handler response includes file content sha256 hash ZMS-176 ([#739](https://github.com/ymir1v/wildduck/issues/739)) ([37374be](https://github.com/ymir1v/wildduck/commit/37374be43903737f6c4710537b6fe281fa3ab434))
* **idle:** Fixed IDLE bug with Outlook ([f2c8545](https://github.com/ymir1v/wildduck/commit/f2c8545293277b382b2d357671e9649e9f7c3b9e))
* **imap-indexer:** fix fileContentHash error in imap indexer, check for attachmentInfo beforehand ZMS-186 ([#756](https://github.com/ymir1v/wildduck/issues/756)) ([7daa0e3](https://github.com/ymir1v/wildduck/commit/7daa0e35d5462c46ff4228638f2e9e5f30ed880d))
...
* **imap-socket-hang:** When allocating IMAP connection, check if socket is still alive ZMS-196 ([#772](https://github.com/ymir1v/wildduck/issues/772)) ([8feae38](https://github.com/ymir1v/wildduck/commit/8feae388367ca8804bb009a8d745e79c64aa9d25))
...
* **IMAP:** Use a non-round number for socket timeout to decrease race conditions where both the server and the client wait for the same time ([686cd86](https://github.com/ymir1v/wildduck/commit/686cd8644c34c11099752d0d26430080b649edab))
...
* **lib-filter:** ZMS-161 ([#718](https://github.com/ymir1v/wildduck/issues/718)) ([f32dc14](https://github.com/ymir1v/wildduck/commit/f32dc147e631ac398d5d3a661611e607d2688c47))
* **log:** Log validation information if command schema validation fails ([1354bf0](https://github.com/ymir1v/wildduck/commit/1354bf0c0508355f77d1fccf8877148513997b29))
...
* **messages-api-timeout:** Add maxTimeMS timeout to mongopaging queries in messages api ZMS-204 ([#799](https://github.com/ymir1v/wildduck/issues/799)) ([3c9aa2a](https://github.com/ymir1v/wildduck/commit/3c9aa2ac00001c4b0e8f293a52d3bb7f9fbda8d2))
...
* **outbound-mta-relay:** ZMS-171 Add support for an outbound MTA relay ([#787](https://github.com/ymir1v/wildduck/issues/787)) ([77625e8](https://github.com/ymir1v/wildduck/commit/77625e89d7050653a9589610785820ddc6dc3209))
...
* push docker containers to GHCR too ([#746](https://github.com/ymir1v/wildduck/issues/746)) ([2a1b34a](https://github.com/ymir1v/wildduck/commit/2a1b34a2e4c08a29db08b754894228aff5040a78))
* quering for range ZMS-182 ([#742](https://github.com/ymir1v/wildduck/issues/742)) ([3804bea](https://github.com/ymir1v/wildduck/commit/3804bea81eba2e2e865e49f268d072daab630901))
* **readme-copyright:** Add copyright ZMS-180 ([#744](https://github.com/ymir1v/wildduck/issues/744)) ([6542e5b](https://github.com/ymir1v/wildduck/commit/6542e5b09e6b1198490896b9418dae71931be4bd))
...
* **SNI:** delete expired autogenerated SNI certificate ([61c03e1](https://github.com/ymir1v/wildduck/commit/61c03e1725c68fcb0c41e505b4d8cb80b0d73d15))
* **SNI:** disable SNI certificate autogeneration by default ([ecbdc9b](https://github.com/ymir1v/wildduck/commit/ecbdc9be5fefeebc71452f621dcd72e0844955ca))
* **SNI:** do not use the default db for SNI ([a6c53eb](https://github.com/ymir1v/wildduck/commit/a6c53eba1fb3a6ed929050742b8681dafc472ce8))
...
* **thread-info-expunge-moveTo:** Added thread information to EXPUNGE message called after MoveTo action ([#788](https://github.com/ymir1v/wildduck/issues/788)) ([08c5804](https://github.com/ymir1v/wildduck/commit/08c5804798e7ffe1b281859c4edcec2465d058c2))
* **typos:** fixed typos ZMS-167 ([#740](https://github.com/ymir1v/wildduck/issues/740)) ([36fcabc](https://github.com/ymir1v/wildduck/commit/36fcabcd5b996c5afcc808d6af814d15ac652827))
* Update all urls in all files to point to new repo url. ZMS-180 ([#791](https://github.com/ymir1v/wildduck/issues/791)) ([37a686d](https://github.com/ymir1v/wildduck/commit/37a686db0899078be9b666e372b49251c6dbe938))
* update and fix docker workflows ([#794](https://github.com/ymir1v/wildduck/issues/794)) ([7e77db7](https://github.com/ymir1v/wildduck/commit/7e77db782f543b037346449592d1ff8c77570dd1))
